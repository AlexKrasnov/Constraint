...
void Line:: Input()
{
	cout << "Введите параметры линейной функции" << endl;
	cout << "a = ";
	cin >> a;
	cout << "b = ";
	cin >> b;
...
void Ellipse::Input()
{
	cout << "Введите параметры эллиптической функции" << endl;
	cout << "a = ";
	cin >> a; 
	cout <<"b = "; 
	cin >> b;
...
{
	cout << "Введите параметры гиперболы" << endl;
	cout << "a = ";
	cin >> a; 
	cout <<"b = "; 
	cin >> b;
...
void Parabola::Input()
{
	cout << "Введите параметры параболы" << endl;
	cout << "p = ";
	cin >> p;
	cout << " y0 = ";
	cin >> y0;
...
istream& operator >> (istream& in, Constraint& ob)
{
	...
	cout << "Введите правую часть функции: ";
...
{
	out << "Заданная система ограничений имеет вид: " << endl;
